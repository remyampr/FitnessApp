...
//   console.log("Checking workout and userId inside workoutPage : ",workout.id,userId);
...
console.log("handle complete excercise :");
    ...
    console.log("completed excercise : ",completedExercise);
    ...
    if (currentExerciseIndex === workout.exercises.length - 1) {
      // This is the last exercise, show completion modal or navigate to workout summary
      setShowModal(true);
    }else {
      // There are more exercises left, start rest timer or move to next exercise
      setIsResting(true);
      startRestTimer();
      // Increment to the next exercise
  ...
  const handleSaveExerciseData = () => {
    console.log("Save Excercise Data",exerciseData);
    
    if (!exerciseData) return;
 // Create a new completed exercise object with measurements
 const completedExercise = {
  ...exerciseData,
  completedAt: new Date().toISOString(),
  ...
  measurements: {
    ...
    arms: Number(measurements.arms),
    legs: Number(measurements.legs),
  },
};
...
setShowModal(false); // Close modal
    ...
    console.log("workoutComplete",isWorkoutComplete);
