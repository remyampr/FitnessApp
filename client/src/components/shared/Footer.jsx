    ...
    <>
      <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
        <nav>
          ...
          <Link to="/our-trainers" className="link link-hover">
            Trainers
          </Link>
        ...
        <nav>
          ...
          <Link to="/user/signup" className="link link-hover">
            Sign Up
          </Link>
          <Link to="/trainer/signup" className="link link-hover">
            Become a Trainer
          </Link>
        </nav>
        <nav>
          <h6 className="footer-title">Legal</h6>
          <button className="link link-hover text-left">Terms of use</button>
          <button className="link link-hover text-left">
            Privacy policy
          </button>
          <button className="link link-hover text-left">
            Cookie policy
