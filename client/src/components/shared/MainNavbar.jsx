  ...
  return (
    <div className="navbar fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-md border-b border-gray-800/40 px-6 md:px-12 py-4">
      <div className="navbar-start">
        <Link
          to={"/"}
          className="flex items-center space-x-2 text-xl font-bold text-white hover:text-primary transition-colors"
        >
      ...
      <div className="navbar-end flex items-center space-x-4">
        ...
        <div className="hidden md:flex space-x-3">
          ...
          <Link to="/user/signup" className="btn btn-sm btn-primary">
            Sign Up
          </Link>
        </div>
